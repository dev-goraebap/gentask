...
import static dev.goraebap.refarch.jooq.Tables.VERIFICATION_CODES;

import dev.goraebap.refarch.jooq.tables.records.VerificationCodesRecord;
...
import dev.goraebap.refarch.module.user.domain.verification.VerificationPurpose;
