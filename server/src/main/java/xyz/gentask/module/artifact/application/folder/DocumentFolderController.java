...
import xyz.gentask.module.artifact.application.artifact.DocumentRequests.CreateFolder;
import xyz.gentask.module.artifact.application.artifact.DocumentRequests.MoveFolder;
import xyz.gentask.module.artifact.application.artifact.DocumentRequests.RenameFolder;
 ...
 *
 * 담긴 자리는 이름과 같은 자원에 두지 않고 하위 자원으로 가른다. 최상위로 옮기는 것이 값을 비우는
