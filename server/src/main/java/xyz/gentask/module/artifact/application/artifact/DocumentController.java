...
import xyz.gentask.module.artifact.application.artifact.DocumentRequests.CreateDocument;
import xyz.gentask.module.artifact.application.artifact.DocumentRequests.EditDocument;
import xyz.gentask.module.artifact.application.artifact.DocumentRequests.MoveDocument;
import xyz.gentask.module.artifact.application.artifact.DocumentRequests.RevertRevision;
 ...
 * 문서는 프로젝트 아래에 선다.
 *
 * 주소가 담는 것은 프로젝트의 식별자이며 접두어가 아니다. 문서는 번호를 매기지 않으므로 그 자리에
 * 식별자가 그대로 온다.
 */
@RestController
