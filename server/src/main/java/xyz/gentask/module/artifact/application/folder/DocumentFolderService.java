...
import xyz.gentask.module.artifact.application.artifact.DocumentQuery;
import xyz.gentask.module.artifact.application.artifact.DocumentViews.FolderSummary;
...
import xyz.gentask.module.artifact.domain.folder.DocumentFolderName;
...
public class DocumentFolderService {
    ...
    public List<FolderSummary> list(UUID userId, String projectId) {
        return documentQuery.findFolders(projectAccess.requireAccess(userId, projectId));
    }
    ...
    public UUID add(UUID userId, String projectId, String name, String parentId) {
        ...
        DocumentFolder folder = DocumentFolder.create(
                ...
                findParent(internalProjectId, parentId),
                userId,
                clock.instant());
    ...
    public void rename(UUID userId, String projectId, String folderId, String name) {
        UUID internalProjectId = projectAccess.requireAccess(userId, projectId);
        DocumentFolder folder = find(internalProjectId, folderId);
    ...
    public void move(UUID userId, String projectId, String folderId, String parentId) {
        UUID internalProjectId = projectAccess.requireAccess(userId, projectId);
        DocumentFolder folder = find(internalProjectId, folderId);
        UUID targetId = findParent(internalProjectId, parentId);

        ensureNotItselfOrDescendant(internalProjectId, folder.id(), targetId);
