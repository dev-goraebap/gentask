...
/**
 * 아티팩트 본문 값 객체다. 마크다운 자유 서식을 지원하며 최대 100,000자로 제한한다.
 *
...
public record ArtifactBody(String value, String editorState) implements ValueObject {
    ...
    private static final ArtifactBody EMPTY = new ArtifactBody("");

    public static ArtifactBody empty() {
        return EMPTY;
    }

    public static ArtifactBody of(String rawBody) {
        if (rawBody == null) {
            return EMPTY;
        }
        ...
        return new ArtifactBody(rawBody);
    }
