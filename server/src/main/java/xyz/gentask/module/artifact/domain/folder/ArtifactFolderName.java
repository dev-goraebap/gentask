...
/**
 * 아티팩트 폴더 이름 값 객체다(최대 200자).
 *
 * 동일 상위 폴더 하위에 동일한 이름의 폴더가 존재해도 허용한다(DOC-008 A2).
 */
public record ArtifactFolderName(String value) implements ValueObject {

    public static final int MAX = 200;
    public static final String REQUIRED = "이름을 입력해 주세요";

    public static ArtifactFolderName of(String rawName) {
        ...
        return new ArtifactFolderName(strippedName);
    }
