...
import xyz.gentask.module.issue.application.issue.IssueRequests.ChangeState;
import xyz.gentask.module.issue.application.issue.IssueRequests.CreateIssue;
import xyz.gentask.module.issue.application.issue.IssueRequests.EditIssue;
 ...
 * 작업 아이템은 프로젝트 아래에 선다.
 *
 * 번호가 프로젝트 안에서만 유일하므로 주소도 그 아래에 둔다. 번호만으로 여는 자리를 두면 어느
...
public class IssueController {
     ...
     * 작업 아이템을 지운다.
     *
     * 되묻는 것은 화면과 명령줄이 한다. 이 자리는 그것을 강제하지 않으며, 되살릴 자리도 두지
     * 않는다(ITM-005).
     */
