...
import xyz.gentask.module.notification.application.failure.AdminPushViews.PushFailureView;
...
/** 관리자가 알림이 닿지 않은 자리를 보고 정리한다. GT-37. */
@Service
...
public class AdminPushService {
     ...
     *
     * 사용자가 다시 켜면 새 자리가 선다. 관리자가 거두는 것은 그 사용자의 알림을 끄는 것이 아니라
     * 죽은 자리를 목록에서 없애는 일이다.
     */
    @Transactional
