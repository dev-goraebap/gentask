...
class CredentialApiTest {
    ...
    @Test
    @DisplayName("TG-009.01 #1: 가입을 요청하면 그 주소로 코드가 간다")
    ...
    @Test
    @DisplayName("TG-009.01 #3: 코드를 확인하기 전에는 그 이메일로 계정이 생기지 않는다")
    ...
    @Test
    @DisplayName("TG-009.01 #7: 코드를 다시 요청하면 앞서 보낸 것이 더 이상 통하지 않는다")
    ...
    @Test
    @DisplayName("TG-009.01 #8: 정해진 횟수보다 많이 틀리면 그 코드가 거둬진다")
    ...
    @Test
    @DisplayName("TG-009.02 #1: 가입한 이메일로 재설정을 요청하면 그 주소로 코드가 간다")
    ...
    @Test
    @DisplayName("TG-009.02 #3: 재설정하면 그 계정의 세션과 API 토큰이 모두 거둬진다")
    ...
    @Test
    @DisplayName("TG-009.02 #4: 등록되지 않은 이메일도 보낸 경우와 같은 응답을 낸다")
    ...
    @Test
    @DisplayName("TG-009.02 #8: 재설정 코드를 다시 요청하면 앞서 보낸 것이 더 이상 통하지 않는다")
    ...
    @Test
    @DisplayName("TG-009.03 #3: 비밀번호를 바꾸면 지금 쓰는 자리를 뺀 나머지 세션이 거둬진다")
