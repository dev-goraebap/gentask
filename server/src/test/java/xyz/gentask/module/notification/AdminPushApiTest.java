...
class AdminPushApiTest {
    ...
    @Test
    @DisplayName("TG-037 #2: 관리자가 알림 문제를 열면 실패한 자리가 최근 것부터 온다")
    ...
    @Test
    @DisplayName("TG-037 #3: 자리를 거두면 그 기기는 더 이상 보낼 대상이 아니다")
    ...
    @Test
    @DisplayName("TG-037 #4: 처리했다고 표시하면 그 항목이 처리됨으로 갈린다")
