...
class ReminderDispatchTest {
    ...
    @Test
    @DisplayName("GT-34 #1, #2: 시각이 지나면 켜 둔 기기로 작업 제목을 담아 보낸다")
    ...
    @Test
    @DisplayName("GT-34 #3: 이미 보낸 미리 알림은 다시 보내지 않는다")
    ...
    @Test
    @DisplayName("GT-34 #4: 자리가 더 이상 유효하지 않으면 그 자리를 거둔다")
    ...
    @Test
    @DisplayName("GT-34 #5: 켜 둔 기기가 없으면 보내지 않고 넘어간다")
    ...
    @Test
    @DisplayName("GT-37 #1: 발송이 실패하면 그 자리와 사유와 시각을 남긴다")
    ...
    @Test
    @DisplayName("GT-37 #5: 자리가 사라졌다고 답하면 스스로 거두고 그 사실을 남긴다")
