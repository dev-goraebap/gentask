...
import { useEditorPortal } from "../../hooks/use-editor-portal"
...
export const TooltipContent = forwardRef<HTMLDivElement, TooltipContentProps>(
  function TooltipContent(
    ...
    const context = useTooltipContext()
    const container = useEditorPortal()
    ...
    if (portal) {
      return <FloatingPortal root={container} {...portalProps}>{content}</FloatingPortal>
    }
