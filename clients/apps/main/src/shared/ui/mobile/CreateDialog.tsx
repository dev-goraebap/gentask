...
export function CreateDialog({ title, onClose, onSave, withBody = true, nameLabel, bodyLabel }: {
  ...
  return <MobileSurface title={title} presentation="fullscreen" isOpen onOpenChange={(open) => { if (!open) onClose(); }} purpose="form" width={640}>
    <Layout header={<DialogHeader title={title} onOpenChange={onClose} />}
      ...
      footer={<LayoutFooter hasDivider><HStack gap={2} paddingBlock={3}>
