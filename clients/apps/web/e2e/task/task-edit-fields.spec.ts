...
test.describe('작업 속성 편집', () => {
  ...
  test('메모를 편집하고 벗어나면 편집한 메모를 반영한다', async ({ page }) => {
  ...
  test('기한을 고르면 즉시 반영한다', async ({ page }) => {
  ...
  test('미리 알림을 고르면 즉시 반영한다', async ({ page }) => {
  ...
  test('중요 표시를 바꾸면 즉시 반영한다', async ({ page }) => {
  ...
  test('나의 하루에 추가하면 즉시 반영한다', async ({ page }) => {
