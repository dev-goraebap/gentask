...
// TG-016 완료되지 않은 작업 보기

test.describe('TG-016 완료되지 않은 작업 보기', () => {
  test('TG-016 #1: 목록을 열면 완료되지 않은 작업만 보여 준다', async ({ page }) => {
  ...
  test('TG-016 #3: 모르는 스마트 목록을 요청하면 완료되지 않은 작업 전체를 보여 준다', async ({ page }) => {
    await 빈_계정으로_바꾼다(page);
