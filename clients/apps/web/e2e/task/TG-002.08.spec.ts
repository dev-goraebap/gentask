...
test.describe('TG-002.08 작업 삭제', () => {
  ...
  test('TG-002.08 #1: 삭제하겠다고 하면 되돌릴 수 없음을 확인받는다', async ({ page, request }) => {
  ...
  test('TG-002.08 #2: 확인하지 않으면 작업을 그대로 둔다', async ({ page, request }) => {
  ...
  test('TG-002.08 #3: 확인하면 작업을 목록에서 뺀다', async ({ page, request }) => {
