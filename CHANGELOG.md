...
- 인증 세션 방식 보충 자료(`docs/참고/인증-세션-방식-근거2.md`) — 결정-0014의 선택 배경·조회 비용 정량 비교·렌더링 모드별 영향·표준 현황(IETF BCP 초안·OWASP·RFC 9068/7662). 결정의 정본은 결정-0014이며 이 문서는 결정을 바꾸지 않는다
...
- 인증 세션 방식 참고 문서 중복분 2건(`세션-vs-JWT-논쟁-대응.md`, `인증-세션-방식-기술검토서.md`) — 같은 내용의 초기 판이며 `인증-세션-방식-근거2.md`로 통합
