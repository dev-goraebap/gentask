...
test.describe('ST-007 작업 제목 편집', () => {
  ...
  test('ST-007 AC1: 제목을 편집하고 벗어나면 편집한 제목을 반영한다', async ({ page, request }) => {
  ...
  test('ST-007 AC2: 편집한 제목이 비어 있으면 반영하지 않는다', async ({ page, request }) => {
  ...
  test('ST-007 AC4: 편집한 제목이 비어 있으면 사유를 보여 준다', async ({ page, request }) => {
  ...
  test('ST-007 AC3: 편집하다 그만두면 편집하던 제목을 반영하지 않는다', async ({
    page,
    request,
  }) => {
